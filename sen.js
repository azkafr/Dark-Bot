...
senku.sendMessage(mdata.id, buff, MessageType.image, {quoted: sen,caption: teks, contextInfo: {"mentionedJid": [num]}})
...
fkontakk = { key: {
 ...
 message: {
    "contactMessage":{"displayName":'</ Maulana⁴̅⁰͍⁴̵〆⁩',"vcard":"BEGIN:VCARD\nVERSION:3.0\nN:2;Fajar;;;\nFN:resku\nitem1.TEL;waid=62895349917040:+62 895-3499-17040\nitem1.X-ABLabel:Mobile\nEND:VCARD"
 }}}
...
call = calling[1].from
senku.sendMessage(call, `*Sorry ${senku.user.name} Saya Tidak Bisa menerima Panggillan.*\n*Telpon = Block!*\nHubungi Owner Untuk membuka Block\nWhatsApp Owner : wa.me/62895349917040`, MessageType.text)
